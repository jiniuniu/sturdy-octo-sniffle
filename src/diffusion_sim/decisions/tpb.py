...
class TPBDecisionModel:
    ...
    def __init__(
        ...
        self.friction = friction if friction is not None else FrictionModel(base_friction=0.0)
    ...
    def decide_adopt(
        ...
        risk_aversion = agent_state.traits.get("risk_aversion", 0.0) if agent_state.traits else 0.0
    ...
    def decide_share(
        ...
        share_propensity = agent_state.traits.get("share_propensity", 0.8) if agent_state.traits else 0.8
