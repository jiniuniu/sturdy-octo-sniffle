    ...
    with col_worlds:
        ...
        for world in worlds:
            ...
            with st.container():
                ...
                with btn_col2:
                    if st.button(
                        "删除", key=f"del_{world['world_id']}", use_container_width=True
                    ):
                ...
                if st.session_state.get(f"confirm_del_{world['world_id']}"):
                    ...
                    with c1:
                        if st.button(
                            "确认", key=f"yes_{world['world_id']}", type="primary"
                        ):
